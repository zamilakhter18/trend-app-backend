...
export class Init1778156914243 implements MigrationInterface {
  name = "Init1778156914243";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "sponsored_content" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trend_id" uuid NOT NULL, "brand_id" uuid, "budget" numeric(12,2), "placement_bid" numeric(12,2), "is_active" boolean NOT NULL DEFAULT true, "sponsor_name" character varying, "campaign_name" character varying, "placement_slot_weight" integer NOT NULL DEFAULT '0', "starts_at" TIMESTAMP WITH TIME ZONE, "ends_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_74d230453e3a051cfef34e8fe77" PRIMARY KEY ("id")); COMMENT ON COLUMN "sponsored_content"."placement_slot_weight" IS 'Weight for paid placement logic, NOT organic ranking'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "clickouts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "product_id" uuid NOT NULL, "trend_id" uuid, "campaign_id" uuid, "source_type" "public"."clickouts_source_type_enum" NOT NULL DEFAULT 'ORGANIC_FEED', "creator_id" uuid, "session_id" text, "ip_hash" text, "converted" boolean NOT NULL DEFAULT false, "converted_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_b9728b12c76283e6d10c6e8ec1e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "saves" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "trend_id" uuid, "product_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "CHK_e6b06af5c864e0eab5e48ed6f5" CHECK (("trend_id" IS NOT NULL AND "product_id" IS NULL) OR ("trend_id" IS NULL AND "product_id" IS NOT NULL)), CONSTRAINT "PK_d2ca4e689a49cafa0702b4ef91f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trend_id" uuid, "creator_id" uuid, "name" character varying NOT NULL, "description" text, "price" numeric(12,2), "currency" character varying NOT NULL DEFAULT 'USD', "affiliate_url" character varying NOT NULL, "image_url" character varying, "is_sponsored" boolean NOT NULL DEFAULT false, "is_authentic" boolean NOT NULL DEFAULT true, "merchant_name" character varying, "affiliate_network" character varying, "commerce_metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "trend_scores" ("trend_id" uuid NOT NULL, "score" numeric(12,2) NOT NULL DEFAULT '0', "final_score" numeric(12,2) NOT NULL DEFAULT '0', "velocity" numeric(12,2) NOT NULL DEFAULT '0', "ctr_score" numeric(12,2) NOT NULL DEFAULT '0', "save_rate_score" numeric(12,2) NOT NULL DEFAULT '0', "engagement_count" integer NOT NULL DEFAULT '0', "last_updated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "calculated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_90e3c9bf4af87bb6fb6603de6f7" PRIMARY KEY ("trend_id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "trends" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "creator_id" uuid, "source" character varying NOT NULL DEFAULT 'other', "external_id" character varying, "title" character varying NOT NULL, "description" text, "phase" "public"."trends_phase_enum" NOT NULL DEFAULT 'emerging', "phase_updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "content_type" character varying NOT NULL DEFAULT 'ORGANIC', "status" character varying NOT NULL DEFAULT 'PUBLISHED', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_4de18eea43d948e5ea66520e0e8" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "user_profile" ("user_id" uuid NOT NULL, "username" character varying, "email" character varying, "full_name" character varying, "avatar_url" character varying, "role" "public"."user_profile_role_enum" NOT NULL DEFAULT 'user', "trend_score" numeric(10,2) NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_622345c51168e12eba4225a0217" UNIQUE ("username"), CONSTRAINT "UQ_e336cc51b61c40b1b1731308aa5" UNIQUE ("email"), CONSTRAINT "PK_eee360f3bff24af1b6890765201" PRIMARY KEY ("user_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "discount_codes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying NOT NULL, "brand_id" uuid, "discount_type" character varying NOT NULL DEFAULT 'PERCENTAGE', "discount_value" numeric(10,2) NOT NULL, "min_score_required" integer NOT NULL DEFAULT '0', "max_uses" integer, "use_count" integer NOT NULL DEFAULT '0', "is_active" boolean NOT NULL DEFAULT true, "expires_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_b967edd0d46547d4a92b4a1c6b3" UNIQUE ("code"), CONSTRAINT "PK_c0170a28d937472e9ce50fdce17" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
