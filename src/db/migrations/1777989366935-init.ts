...
export class Init1777989366935 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "trend_content" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trend_id" uuid NOT NULL, "content_url" character varying NOT NULL, "content_type" character varying NOT NULL, "is_primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0cda73a9717c8e71262070456e8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "trend_metadata" ("trend_id" uuid NOT NULL, "tags" text array NOT NULL DEFAULT '{}', "categories" text array NOT NULL DEFAULT '{}', "sentiment_score" numeric(5,2), "ai_summary" text, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c93d506d63381dc93d7e7f93970" PRIMARY KEY ("trend_id"))`);
        await queryRunner.query(`CREATE TABLE "engagements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid, "trend_id" uuid, "type" character varying NOT NULL, "content" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_aec8c95c82a37a5791001cdb9ae" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "ai_analysis" ("trend_id" uuid NOT NULL, "raw_analysis" jsonb, "refined_summary" text, "keywords" text array NOT NULL DEFAULT '{}', "vision_data" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_69c631f5fda6aca486c8a0ad0f2" PRIMARY KEY ("trend_id"))`);
        await queryRunner.query(`CREATE TABLE "trend_scores" ("trend_id" uuid NOT NULL, "score" numeric(12,2) NOT NULL DEFAULT '0', "velocity" numeric(12,2) NOT NULL DEFAULT '0', "engagement_count" integer NOT NULL DEFAULT '0', "last_updated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_90e3c9bf4af87bb6fb6603de6f7" PRIMARY KEY ("trend_id"))`);
        await queryRunner.query(`CREATE TABLE "sponsored_content" ("trend_id" uuid NOT NULL, "advertiser_id" uuid, "budget" numeric(12,2), "bid_amount" numeric(12,2), "is_active" boolean NOT NULL DEFAULT true, "starts_at" TIMESTAMP WITH TIME ZONE, "ends_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_d2b512a8b0994f668cef59f135a" PRIMARY KEY ("trend_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_profile" ("user_id" uuid NOT NULL, "username" character varying, "full_name" character varying, "avatar_url" character varying, "trend_score" numeric(10,2) NOT NULL DEFAULT '0', "level" integer NOT NULL DEFAULT '1', "badges" text array NOT NULL DEFAULT '{}', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_622345c51168e12eba4225a0217" UNIQUE ("username"), CONSTRAINT "PK_eee360f3bff24af1b6890765201" PRIMARY KEY ("user_id"))`);
