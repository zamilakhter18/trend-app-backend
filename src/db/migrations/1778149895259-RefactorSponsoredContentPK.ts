...
export class RefactorSponsoredContentPK1778149895259 implements MigrationInterface {
  name = "RefactorSponsoredContentPK1778149895259";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."trend_signals_source_enum" AS ENUM('instagram', 'tiktok', 'x', 'pinterest', 'other')`);
    await queryRunner.query(`CREATE TYPE "public"."trend_signals_signal_type_enum" AS ENUM('velocity', 'saves', 'growth', 'momentum')`);
    await queryRunner.query(
      `CREATE TABLE "trend_signals" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trend_id" uuid NOT NULL, "source" "public"."trend_signals_source_enum" NOT NULL DEFAULT 'other', "signal_type" "public"."trend_signals_signal_type_enum" NOT NULL, "signal_value" numeric(10,2) NOT NULL, "metadata" jsonb DEFAULT '{}', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_d1ba65e115f839c6be87f7cdc47" PRIMARY KEY ("id"))`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE "public"."trend_signals_source_enum"`);
